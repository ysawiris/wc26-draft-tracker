...
- **🛣 Road to No. 1** — a personal race command center that leads the **Odds** tab, built for *your* team (the one you claimed). It writes the live story in one line ("Taco Corp sits 6th, 3 goals back of Gallactic Rebel Scum"), and shows the four numbers that matter: goals back of the lead, your cushion on the team chasing you, how many of your group's matches are still to play, and the betting model's shot at the No. 1 pick. A projected-finish track marks where you are now vs. where the model expects you to land. When one of your group's matches is live, a pulsing strip carries the score. One tap **📋 copies your status** for the group chat; another jumps to the full Odds forecast. (No team claimed yet? It becomes a one-tap prompt to pick one.)
